...
// Common copy functions for geographic_msgs/RouteNetwork
#ifdef _MSC_VER
#pragma warning(push)
...
class GEOGRAPHIC_MSGS_EXPORT ros2_geographic_msgs_msg_RouteNetwork_common : public MATLABROS2MsgInterface<geographic_msgs::msg::RouteNetwork> {
  public:
    virtual ~ros2_geographic_msgs_msg_RouteNetwork_common(){}
    virtual void copy_from_struct(geographic_msgs::msg::RouteNetwork* msg, const matlab::data::Struct& arr, MultiLibLoader loader); 
    //----------------------------------------------------------------------------
    virtual MDArray_T get_arr(MDFactory_T& factory, const geographic_msgs::msg::RouteNetwork* msg, MultiLibLoader loader, size_t size = 1);
};
  void ros2_geographic_msgs_msg_RouteNetwork_common::copy_from_struct(geographic_msgs::msg::RouteNetwork* msg, const matlab::data::Struct& arr,
    ...
    try {
        ...
        for (auto _segmentsarr : segments_arr) {
        	geographic_msgs::msg::RouteSegment _val;
        auto msgClassPtr_segments = getCommonObject<geographic_msgs::msg::RouteSegment>("ros2_geographic_msgs_msg_RouteSegment_common",loader);
  ...
  //----------------------------------------------------------------------------
  MDArray_T ros2_geographic_msgs_msg_RouteNetwork_common::get_arr(MDFactory_T& factory, const geographic_msgs::msg::RouteNetwork* msg,
       MultiLibLoader loader, size_t size) {
    auto outArray = factory.createStructArray({size,1},{"MessageType","header","id","bounds","points","segments","props"});
    for(size_t ctr = 0; ctr < size; ctr++){
    outArray[ctr]["MessageType"] = factory.createCharArray("geographic_msgs/RouteNetwork");
    // header
...
class GEOGRAPHIC_MSGS_EXPORT ros2_geographic_msgs_RouteNetwork_message : public ROS2MsgElementInterfaceFactory {
  public:
    virtual ~ros2_geographic_msgs_RouteNetwork_message(){}
  ...
  std::shared_ptr<MATLABPublisherInterface> 
          ros2_geographic_msgs_RouteNetwork_message::generatePublisherInterface(ElementType /*type*/){
    return std::make_shared<ROS2PublisherImpl<geographic_msgs::msg::RouteNetwork,ros2_geographic_msgs_msg_RouteNetwork_common>>();
  }
  std::shared_ptr<MATLABSubscriberInterface> 
         ros2_geographic_msgs_RouteNetwork_message::generateSubscriberInterface(ElementType /*type*/){
    return std::make_shared<ROS2SubscriberImpl<geographic_msgs::msg::RouteNetwork,ros2_geographic_msgs_msg_RouteNetwork_common>>();
  }
  std::shared_ptr<void> ros2_geographic_msgs_RouteNetwork_message::generateCppMessage(ElementType /*type*/, 
                                           const matlab::data::StructArray& arr,
                                           MultiLibLoader loader,
                                           std::map<std::string,std::shared_ptr<MATLABROS2MsgInterfaceBase>>* commonObjMap){
    auto msg = std::make_shared<geographic_msgs::msg::RouteNetwork>();
    ros2_geographic_msgs_msg_RouteNetwork_common commonObj;
    commonObj.mCommonObjMap = commonObjMap;
    commonObj.copy_from_struct(msg.get(), arr[0], loader);
    return msg;
  }
  matlab::data::StructArray ros2_geographic_msgs_RouteNetwork_message::generateMLMessage(ElementType  /*type*/ ,
                                                    void*  msg ,
                                                    MultiLibLoader  loader ,
                                                    std::map<std::string,std::shared_ptr<MATLABROS2MsgInterfaceBase>>*  commonObjMap ){
    ros2_geographic_msgs_msg_RouteNetwork_common commonObj;	
    commonObj.mCommonObjMap = commonObjMap;	
    MDFactory_T factory;
    return commonObj.get_arr(factory, (geographic_msgs::msg::RouteNetwork*)msg, loader);			
 }
#include "class_loader/register_macro.hpp"
// Register the component with class_loader.
// This acts as a sort of entry point, allowing the component to be discoverable when its library
// is being loaded into a running process.
CLASS_LOADER_REGISTER_CLASS(ros2_geographic_msgs_msg_RouteNetwork_common, MATLABROS2MsgInterface<geographic_msgs::msg::RouteNetwork>)
CLASS_LOADER_REGISTER_CLASS(ros2_geographic_msgs_RouteNetwork_message, ROS2MsgElementInterfaceFactory)
#ifdef _MSC_VER
#pragma warning(pop)
#else
