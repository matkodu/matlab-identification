...
// Common copy functions for labust_msgs/HLMessage
#ifdef _MSC_VER
#pragma warning(push)
...
#include "labust_msgs/msg/hl_message.hpp"
#include "visibility_control.h"
#include "class_loader/multi_library_class_loader.hpp"
#include "ROS2PubSubTemplates.hpp"
class LABUST_MSGS_EXPORT ros2_labust_msgs_msg_HLMessage_common : public MATLABROS2MsgInterface<labust_msgs::msg::HLMessage> {
  public:
    virtual ~ros2_labust_msgs_msg_HLMessage_common(){}
    virtual void copy_from_struct(labust_msgs::msg::HLMessage* msg, const matlab::data::Struct& arr, MultiLibLoader loader); 
    //----------------------------------------------------------------------------
    virtual MDArray_T get_arr(MDFactory_T& factory, const labust_msgs::msg::HLMessage* msg, MultiLibLoader loader, size_t size = 1);
};
  void ros2_labust_msgs_msg_HLMessage_common::copy_from_struct(labust_msgs::msg::HLMessage* msg, const matlab::data::Struct& arr,
  ...
  //----------------------------------------------------------------------------
  MDArray_T ros2_labust_msgs_msg_HLMessage_common::get_arr(MDFactory_T& factory, const labust_msgs::msg::HLMessage* msg,
    ...
    outArray[ctr]["MessageType"] = factory.createCharArray("labust_msgs/HLMessage");
    // STOP
...
class LABUST_MSGS_EXPORT ros2_labust_msgs_HLMessage_message : public ROS2MsgElementInterfaceFactory {
  public:
    virtual ~ros2_labust_msgs_HLMessage_message(){}
  ...
  std::shared_ptr<MATLABPublisherInterface> 
          ros2_labust_msgs_HLMessage_message::generatePublisherInterface(ElementType /*type*/){
    return std::make_shared<ROS2PublisherImpl<labust_msgs::msg::HLMessage,ros2_labust_msgs_msg_HLMessage_common>>();
  }
  std::shared_ptr<MATLABSubscriberInterface> 
         ros2_labust_msgs_HLMessage_message::generateSubscriberInterface(ElementType /*type*/){
    return std::make_shared<ROS2SubscriberImpl<labust_msgs::msg::HLMessage,ros2_labust_msgs_msg_HLMessage_common>>();
  }
  std::shared_ptr<void> ros2_labust_msgs_HLMessage_message::generateCppMessage(ElementType /*type*/, 
                                           const matlab::data::StructArray& arr,
                                           MultiLibLoader loader,
                                           std::map<std::string,std::shared_ptr<MATLABROS2MsgInterfaceBase>>* commonObjMap){
    auto msg = std::make_shared<labust_msgs::msg::HLMessage>();
    ros2_labust_msgs_msg_HLMessage_common commonObj;
    commonObj.mCommonObjMap = commonObjMap;
    commonObj.copy_from_struct(msg.get(), arr[0], loader);
    return msg;
  }
  matlab::data::StructArray ros2_labust_msgs_HLMessage_message::generateMLMessage(ElementType  /*type*/ ,
                                                    void*  msg ,
                                                    MultiLibLoader  loader ,
                                                    std::map<std::string,std::shared_ptr<MATLABROS2MsgInterfaceBase>>*  commonObjMap ){
    ros2_labust_msgs_msg_HLMessage_common commonObj;	
    commonObj.mCommonObjMap = commonObjMap;	
    MDFactory_T factory;
    return commonObj.get_arr(factory, (labust_msgs::msg::HLMessage*)msg, loader);			
 }
#include "class_loader/register_macro.hpp"
// Register the component with class_loader.
// This acts as a sort of entry point, allowing the component to be discoverable when its library
// is being loaded into a running process.
CLASS_LOADER_REGISTER_CLASS(ros2_labust_msgs_msg_HLMessage_common, MATLABROS2MsgInterface<labust_msgs::msg::HLMessage>)
CLASS_LOADER_REGISTER_CLASS(ros2_labust_msgs_HLMessage_message, ROS2MsgElementInterfaceFactory)
#ifdef _MSC_VER
#pragma warning(pop)
#else
