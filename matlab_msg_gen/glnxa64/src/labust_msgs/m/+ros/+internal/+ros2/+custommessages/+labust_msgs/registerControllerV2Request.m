function [data, info] = registerControllerV2Request
%RegisterControllerV2 gives an empty data for labust_msgs/RegisterControllerV2Request
% Copyright 2019-2021 The MathWorks, Inc.
data = struct();
data.MessageType = 'labust_msgs/RegisterControllerV2Request';
...
info.MessageType = 'labust_msgs/RegisterControllerV2Request';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
