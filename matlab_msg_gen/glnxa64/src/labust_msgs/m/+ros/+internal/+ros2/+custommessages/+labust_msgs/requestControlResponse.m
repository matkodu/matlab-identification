function [data, info] = requestControlResponse
%RequestControl gives an empty data for labust_msgs/RequestControlResponse
% Copyright 2019-2021 The MathWorks, Inc.
data = struct();
data.MessageType = 'labust_msgs/RequestControlResponse';
...
info.MessageType = 'labust_msgs/RequestControlResponse';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
