function ros1msg = labust_msgs_msg_Go2PointFA_2To1_Converter(message,ros1msg)
%labust_msgs_msg_Go2PointFA_2To1_Converter passes data of ROS 2 message to ROS message.
