function [data, info] = dockingPrimitiveServiceRequest
%DockingPrimitiveService gives an empty data for labust_msgs/DockingPrimitiveServiceRequest
% Copyright 2019-2021 The MathWorks, Inc.
data = struct();
data.MessageType = 'labust_msgs/DockingPrimitiveServiceRequest';
...
info.MessageType = 'labust_msgs/DockingPrimitiveServiceRequest';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
