...
{
  return max_serialized_size_geographic_msgs__srv__UpdateGeographicMap_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_geographic_msgs__srv__UpdateGeographicMap_Response(
    full_bounded, 0);
}
