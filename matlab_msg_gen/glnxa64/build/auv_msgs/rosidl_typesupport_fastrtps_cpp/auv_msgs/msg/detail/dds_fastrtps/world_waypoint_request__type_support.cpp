...
#include "auv_msgs/msg/detail/world_waypoint_request__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const auv_msgs::msg::WorldWaypointRequest & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  auv_msgs::msg::WorldWaypointRequest & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_auv_msgs
max_serialized_size_WorldWaypointRequest(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const auv_msgs::msg::WorldWaypointRequest *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<auv_msgs::msg::WorldWaypointRequest *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _WorldWaypointRequest__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const auv_msgs::msg::WorldWaypointRequest *>(
...
{
  return max_serialized_size_WorldWaypointRequest(full_bounded, 0);
}

static message_type_support_callbacks_t _WorldWaypointRequest__callbacks = {
  "auv_msgs::msg",
...
static rosidl_message_type_support_t _WorldWaypointRequest__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_WorldWaypointRequest__callbacks,
...
{
  return &auv_msgs::msg::typesupport_fastrtps_cpp::_WorldWaypointRequest__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, auv_msgs, msg, WorldWaypointRequest)() {
  return &auv_msgs::msg::typesupport_fastrtps_cpp::_WorldWaypointRequest__handle;
}
