...
#include "auv_msgs/msg/detail/ned_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const auv_msgs::msg::NEDArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  auv_msgs::msg::NEDArray & ros_message)
{
  // Member: neds
  {
    uint32_t cdrSize;
  ...
  // Member: neds
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.neds[index], current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const auv_msgs::msg::NEDArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<auv_msgs::msg::NEDArray *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _NEDArray__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const auv_msgs::msg::NEDArray *>(
...
{
  return max_serialized_size_NEDArray(full_bounded, 0);
}

static message_type_support_callbacks_t _NEDArray__callbacks = {
  "auv_msgs::msg",
  "NEDArray",
...
static rosidl_message_type_support_t _NEDArray__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_NEDArray__callbacks,
...
{
  return &auv_msgs::msg::typesupport_fastrtps_cpp::_NEDArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, auv_msgs, msg, NEDArray)() {
  return &auv_msgs::msg::typesupport_fastrtps_cpp::_NEDArray__handle;
}
