...
#include "auv_msgs/msg/detail/vehicle_pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const auv_msgs::msg::VehiclePose *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<auv_msgs::msg::VehiclePose *>(
    untyped_ros_message);
...
{
  return &auv_msgs::msg::typesupport_fastrtps_cpp::_VehiclePose__handle;
}
