...
#include "auv_msgs/msg/detail/body_force_request__rosidl_typesupport_fastrtps_c.h"
...
using _BodyForceRequest__ros_msg_type = auv_msgs__msg__BodyForceRequest;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _BodyForceRequest__ros_msg_type * ros_message = static_cast<const _BodyForceRequest__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _BodyForceRequest__ros_msg_type * ros_message = static_cast<_BodyForceRequest__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_auv_msgs__msg__BodyForceRequest(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _BodyForceRequest__ros_msg_type * ros_message = static_cast<const _BodyForceRequest__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _BodyForceRequest__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_auv_msgs__msg__BodyForceRequest(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_auv_msgs
size_t max_serialized_size_auv_msgs__msg__BodyForceRequest(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_auv_msgs__msg__BodyForceRequest(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_BodyForceRequest = {
  "auv_msgs::msg",
  "BodyForceRequest",
...
static rosidl_message_type_support_t _BodyForceRequest__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_BodyForceRequest,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, auv_msgs, msg, BodyForceRequest)() {
  return &_BodyForceRequest__type_support;
}
