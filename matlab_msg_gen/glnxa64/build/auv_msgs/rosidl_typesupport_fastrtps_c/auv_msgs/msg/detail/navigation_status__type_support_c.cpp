...
#include "auv_msgs/msg/detail/navigation_status__rosidl_typesupport_fastrtps_c.h"
...
#include "auv_msgs/msg/detail/ned__functions.h"  // position, position_variance
#include "geographic_msgs/msg/detail/geo_point__functions.h"  // global_position, origin
#include "geometry_msgs/msg/detail/point__functions.h"  // body_velocity, seafloor_velocity
#include "geometry_msgs/msg/detail/vector3__functions.h"  // orientation, orientation_rate, orientation_variance
...
using _NavigationStatus__ros_msg_type = auv_msgs__msg__NavigationStatus;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: seafloor_velocity
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->seafloor_velocity, cdr))
    {
      return false;
    }
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: seafloor_velocity
  {
    ...
    if (!callbacks->cdr_deserialize(
        cdr, &ros_message->seafloor_velocity))
    {
      return false;
    }
  }
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_geometry_msgs__msg__Point(
    &(ros_message->seafloor_velocity), current_alignment);
  // field.name orientation
...
static uint32_t _NavigationStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_auv_msgs__msg__NavigationStatus(
...
static size_t _NavigationStatus__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_auv_msgs__msg__NavigationStatus(
    full_bounded, 0);
}
