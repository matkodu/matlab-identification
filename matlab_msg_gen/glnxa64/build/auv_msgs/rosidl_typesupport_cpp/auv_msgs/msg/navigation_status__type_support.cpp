...
static const _NavigationStatus_type_support_symbol_names_t _NavigationStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, auv_msgs, msg, NavigationStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, auv_msgs, msg, NavigationStatus)),
  }
};
...
get_message_type_support_handle<auv_msgs::msg::NavigationStatus>()
{
  return &::auv_msgs::msg::rosidl_typesupport_cpp::NavigationStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, auv_msgs, msg, NavigationStatus)() {
  return get_message_type_support_handle<auv_msgs::msg::NavigationStatus>();
}
