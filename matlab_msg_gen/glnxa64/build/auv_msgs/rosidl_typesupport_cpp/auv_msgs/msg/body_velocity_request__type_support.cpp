...
static const _BodyVelocityRequest_type_support_symbol_names_t _BodyVelocityRequest_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, auv_msgs, msg, BodyVelocityRequest)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, auv_msgs, msg, BodyVelocityRequest)),
  }
};
...
{
  return &::auv_msgs::msg::rosidl_typesupport_cpp::BodyVelocityRequest_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, auv_msgs, msg, BodyVelocityRequest)() {
  return get_message_type_support_handle<auv_msgs::msg::BodyVelocityRequest>();
}
