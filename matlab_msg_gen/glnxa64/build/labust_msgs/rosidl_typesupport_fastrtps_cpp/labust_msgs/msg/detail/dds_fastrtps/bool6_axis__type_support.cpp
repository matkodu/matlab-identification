...
#include "labust_msgs/msg/detail/bool6_axis__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const labust_msgs::msg::Bool6Axis & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  labust_msgs::msg::Bool6Axis & ros_message)
{
  // Member: x
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const labust_msgs::msg::Bool6Axis *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<labust_msgs::msg::Bool6Axis *>(
    untyped_ros_message);
...
{
  return max_serialized_size_Bool6Axis(full_bounded, 0);
}
...
{
  return &labust_msgs::msg::typesupport_fastrtps_cpp::_Bool6Axis__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, labust_msgs, msg, Bool6Axis)() {
  return &labust_msgs::msg::typesupport_fastrtps_cpp::_Bool6Axis__handle;
}
