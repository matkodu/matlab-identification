...
#include "labust_msgs/msg/detail/body_force_req__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const labust_msgs::msg::GoalDescriptor &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  labust_msgs::msg::GoalDescriptor &);
size_t get_serialized_size(
  const labust_msgs::msg::GoalDescriptor &,
  size_t current_alignment);
size_t
...
{
bool cdr_serialize(
  const labust_msgs::msg::Windup6Axis &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  labust_msgs::msg::Windup6Axis &);
size_t get_serialized_size(
  const labust_msgs::msg::Windup6Axis &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const labust_msgs::msg::BodyForceReq & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  labust_msgs::msg::BodyForceReq & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  current_alignment +=
    labust_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
    ros_message.windup, current_alignment);
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        labust_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_GoalDescriptor(
        full_bounded, current_alignment);
    }
  }
  ...
  // Member: windup
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        labust_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Windup6Axis(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const labust_msgs::msg::BodyForceReq *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<labust_msgs::msg::BodyForceReq *>(
    untyped_ros_message);
...
static size_t _BodyForceReq__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_BodyForceReq(full_bounded, 0);
}
...
{
  return &labust_msgs::msg::typesupport_fastrtps_cpp::_BodyForceReq__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, labust_msgs, msg, BodyForceReq)() {
  return &labust_msgs::msg::typesupport_fastrtps_cpp::_BodyForceReq__handle;
}
