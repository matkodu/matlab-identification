...
#include "labust_msgs/msg/detail/iso__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const labust_msgs::msg::ISO & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  labust_msgs::msg::ISO & ros_message)
{
  // Member: dof
  cdr >> ros_message.dof;
...
{
  auto typed_message =
    static_cast<const labust_msgs::msg::ISO *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<labust_msgs::msg::ISO *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ISO__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const labust_msgs::msg::ISO *>(
...
{
  return max_serialized_size_ISO(full_bounded, 0);
}

static message_type_support_callbacks_t _ISO__callbacks = {
  "labust_msgs::msg",
  "ISO",
  _ISO__cdr_serialize,
...
static rosidl_message_type_support_t _ISO__handle = {
...
{
  return &labust_msgs::msg::typesupport_fastrtps_cpp::_ISO__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, labust_msgs, msg, ISO)() {
  return &labust_msgs::msg::typesupport_fastrtps_cpp::_ISO__handle;
}
