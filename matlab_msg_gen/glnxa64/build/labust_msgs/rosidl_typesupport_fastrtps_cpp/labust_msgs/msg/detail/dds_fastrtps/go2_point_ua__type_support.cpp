...
#include "labust_msgs/msg/detail/go2_point_ua__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const labust_msgs::msg::Go2PointUA & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  labust_msgs::msg::Go2PointUA & ros_message)
{
  // Member: point
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_labust_msgs
max_serialized_size_Go2PointUA(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const labust_msgs::msg::Go2PointUA *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<labust_msgs::msg::Go2PointUA *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Go2PointUA__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const labust_msgs::msg::Go2PointUA *>(
...
{
  return max_serialized_size_Go2PointUA(full_bounded, 0);
}

static message_type_support_callbacks_t _Go2PointUA__callbacks = {
  "labust_msgs::msg",
  "Go2PointUA",
...
static rosidl_message_type_support_t _Go2PointUA__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Go2PointUA__callbacks,
...
{
  return &labust_msgs::msg::typesupport_fastrtps_cpp::_Go2PointUA__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, labust_msgs, msg, Go2PointUA)() {
  return &labust_msgs::msg::typesupport_fastrtps_cpp::_Go2PointUA__handle;
}
