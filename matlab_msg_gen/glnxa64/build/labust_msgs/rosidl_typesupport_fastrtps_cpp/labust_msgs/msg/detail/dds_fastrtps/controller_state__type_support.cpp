...
#include "labust_msgs/msg/detail/controller_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const labust_msgs::msg::ControllerInfo &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  labust_msgs::msg::ControllerInfo &);
...
cdr_serialize(
  const labust_msgs::msg::ControllerState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  labust_msgs::msg::ControllerState & ros_message)
{
  // Member: name
  {
    cdr >> ros_message.name;
  ...
  size_t current_alignment)
{
  ...
  // Member: info
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        labust_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_ControllerInfo(
...
{
  auto typed_message =
    static_cast<const labust_msgs::msg::ControllerState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<labust_msgs::msg::ControllerState *>(
    untyped_ros_message);
...
{
  return &labust_msgs::msg::typesupport_fastrtps_cpp::_ControllerState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, labust_msgs, msg, ControllerState)() {
  return &labust_msgs::msg::typesupport_fastrtps_cpp::_ControllerState__handle;
}
