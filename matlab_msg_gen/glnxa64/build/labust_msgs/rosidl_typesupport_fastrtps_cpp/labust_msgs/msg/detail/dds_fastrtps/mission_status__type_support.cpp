...
#include "labust_msgs/msg/detail/mission_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  labust_msgs::msg::MissionStatus & ros_message)
{
  // Member: mission_active
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const labust_msgs::msg::MissionStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<labust_msgs::msg::MissionStatus *>(
    untyped_ros_message);
...
{
  return &labust_msgs::msg::typesupport_fastrtps_cpp::_MissionStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, labust_msgs, msg, MissionStatus)() {
  return &labust_msgs::msg::typesupport_fastrtps_cpp::_MissionStatus__handle;
}
