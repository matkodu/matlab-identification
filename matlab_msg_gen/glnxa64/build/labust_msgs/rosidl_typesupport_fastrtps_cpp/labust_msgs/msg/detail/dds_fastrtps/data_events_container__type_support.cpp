...
#include "labust_msgs/msg/detail/data_events_container__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const labust_msgs::msg::DataEventsContainer & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: state_var
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.state_var,
    cdr);
  // Member: mission_var
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.mission_var,
    cdr);
  // Member: events_var
  {
    cdr << ros_message.events_var;
  }
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  labust_msgs::msg::DataEventsContainer & ros_message)
{
  // Member: state_var
  ...
  size_t current_alignment)
{
  ...
  // Member: events_var
  {
    ...
    size_t item_size = sizeof(ros_message.events_var[0]);
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_labust_msgs
max_serialized_size_DataEventsContainer(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const labust_msgs::msg::DataEventsContainer *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<labust_msgs::msg::DataEventsContainer *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _DataEventsContainer__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const labust_msgs::msg::DataEventsContainer *>(
...
{
  return max_serialized_size_DataEventsContainer(full_bounded, 0);
}

static message_type_support_callbacks_t _DataEventsContainer__callbacks = {
  "labust_msgs::msg",
  "DataEventsContainer",
...
static rosidl_message_type_support_t _DataEventsContainer__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DataEventsContainer__callbacks,
...
{
  return &labust_msgs::msg::typesupport_fastrtps_cpp::_DataEventsContainer__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, labust_msgs, msg, DataEventsContainer)() {
  return &labust_msgs::msg::typesupport_fastrtps_cpp::_DataEventsContainer__handle;
}
