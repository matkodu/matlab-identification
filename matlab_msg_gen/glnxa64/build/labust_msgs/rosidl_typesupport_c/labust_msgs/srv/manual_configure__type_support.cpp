...
static const _ManualConfigure_Request_type_support_symbol_names_t _ManualConfigure_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, labust_msgs, srv, ManualConfigure_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, labust_msgs, srv, ManualConfigure_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, labust_msgs, srv, ManualConfigure_Request)() {
  return &::labust_msgs::srv::rosidl_typesupport_c::ManualConfigure_Request_message_type_support_handle;
}
...
static const _ManualConfigure_Response_type_support_symbol_names_t _ManualConfigure_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, labust_msgs, srv, ManualConfigure_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, labust_msgs, srv, ManualConfigure_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_labust_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, labust_msgs, srv, ManualConfigure_Response)() {
  return &::labust_msgs::srv::rosidl_typesupport_c::ManualConfigure_Response_message_type_support_handle;
}
...
static const _ManualConfigure_type_support_symbol_names_t _ManualConfigure_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, labust_msgs, srv, ManualConfigure)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, labust_msgs, srv, ManualConfigure)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, labust_msgs, srv, ManualConfigure)() {
  return &::labust_msgs::srv::rosidl_typesupport_c::ManualConfigure_service_type_support_handle;
}
