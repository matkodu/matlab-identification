...
static const _RegisterControllerV3_Request_type_support_symbol_names_t _RegisterControllerV3_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, labust_msgs, srv, RegisterControllerV3_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, labust_msgs, srv, RegisterControllerV3_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, labust_msgs, srv, RegisterControllerV3_Request)() {
  return &::labust_msgs::srv::rosidl_typesupport_c::RegisterControllerV3_Request_message_type_support_handle;
}
...
static const _RegisterControllerV3_Response_type_support_symbol_names_t _RegisterControllerV3_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, labust_msgs, srv, RegisterControllerV3_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, labust_msgs, srv, RegisterControllerV3_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_labust_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, labust_msgs, srv, RegisterControllerV3_Response)() {
  return &::labust_msgs::srv::rosidl_typesupport_c::RegisterControllerV3_Response_message_type_support_handle;
}
...
static const _RegisterControllerV3_type_support_symbol_names_t _RegisterControllerV3_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, labust_msgs, srv, RegisterControllerV3)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, labust_msgs, srv, RegisterControllerV3)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, labust_msgs, srv, RegisterControllerV3)() {
  return &::labust_msgs::srv::rosidl_typesupport_c::RegisterControllerV3_service_type_support_handle;
}
