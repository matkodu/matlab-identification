...
static const _PIDParamsUpdate_type_support_symbol_names_t _PIDParamsUpdate_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, labust_msgs, msg, PIDParamsUpdate)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, labust_msgs, msg, PIDParamsUpdate)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, labust_msgs, msg, PIDParamsUpdate)() {
  return &::labust_msgs::msg::rosidl_typesupport_c::PIDParamsUpdate_message_type_support_handle;
}
