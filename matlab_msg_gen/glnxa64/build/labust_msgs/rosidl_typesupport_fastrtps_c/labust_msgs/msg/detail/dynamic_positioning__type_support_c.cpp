...
#include "labust_msgs/msg/detail/dynamic_positioning__rosidl_typesupport_fastrtps_c.h"
...
using _DynamicPositioning__ros_msg_type = labust_msgs__msg__DynamicPositioning;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _DynamicPositioning__ros_msg_type * ros_message = static_cast<const _DynamicPositioning__ros_msg_type *>(untyped_ros_message);
  // Field name: point
  {
  ...
  void * untyped_ros_message)
{
  ...
  _DynamicPositioning__ros_msg_type * ros_message = static_cast<_DynamicPositioning__ros_msg_type *>(untyped_ros_message);
  // Field name: point
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_labust_msgs__msg__DynamicPositioning(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _DynamicPositioning__ros_msg_type * ros_message = static_cast<const _DynamicPositioning__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _DynamicPositioning__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_labust_msgs__msg__DynamicPositioning(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_labust_msgs
size_t max_serialized_size_labust_msgs__msg__DynamicPositioning(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_labust_msgs__msg__DynamicPositioning(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_DynamicPositioning = {
  "labust_msgs::msg",
  "DynamicPositioning",
...
static rosidl_message_type_support_t _DynamicPositioning__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_DynamicPositioning,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, labust_msgs, msg, DynamicPositioning)() {
  return &_DynamicPositioning__type_support;
}
