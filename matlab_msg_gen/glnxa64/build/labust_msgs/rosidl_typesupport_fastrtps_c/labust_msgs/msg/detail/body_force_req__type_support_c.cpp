...
#include "labust_msgs/msg/detail/body_force_req__rosidl_typesupport_fastrtps_c.h"
...
#include "labust_msgs/msg/detail/windup6_axis__functions.h"  // windup
...
using _BodyForceReq__ros_msg_type = labust_msgs__msg__BodyForceReq;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: windup
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, labust_msgs, msg, Windup6Axis
      )()->data);
    if (!callbacks->cdr_serialize(
        &ros_message->windup, cdr))
    {
      return false;
    }
  }
...
size_t get_serialized_size_labust_msgs__msg__BodyForceReq(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _BodyForceReq__ros_msg_type * ros_message = static_cast<const _BodyForceReq__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_labust_msgs__msg__Windup6Axis(
...
static uint32_t _BodyForceReq__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_labust_msgs__msg__BodyForceReq(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_labust_msgs
size_t max_serialized_size_labust_msgs__msg__BodyForceReq(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: windup
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_labust_msgs__msg__Windup6Axis(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_labust_msgs__msg__BodyForceReq(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, labust_msgs, msg, BodyForceReq)() {
