...
#include "labust_msgs/msg/detail/body_velocity_req__rosidl_typesupport_fastrtps_c.h"
...
using _BodyVelocityReq__ros_msg_type = labust_msgs__msg__BodyVelocityReq;
...
size_t get_serialized_size_labust_msgs__msg__BodyVelocityReq(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _BodyVelocityReq__ros_msg_type * ros_message = static_cast<const _BodyVelocityReq__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _BodyVelocityReq__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_labust_msgs__msg__BodyVelocityReq(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_labust_msgs
size_t max_serialized_size_labust_msgs__msg__BodyVelocityReq(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_labust_msgs__msg__BodyVelocityReq(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, labust_msgs, msg, BodyVelocityReq)() {
