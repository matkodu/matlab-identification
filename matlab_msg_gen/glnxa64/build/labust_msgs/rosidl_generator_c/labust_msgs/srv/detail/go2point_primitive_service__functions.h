...
#ifndef LABUST_MSGS__SRV__DETAIL__GO2POINT_PRIMITIVE_SERVICE__FUNCTIONS_H_
#define LABUST_MSGS__SRV__DETAIL__GO2POINT_PRIMITIVE_SERVICE__FUNCTIONS_H_
...
/// Initialize srv/Go2pointPrimitiveService message.
/**
...
/// Finalize srv/Go2pointPrimitiveService message.
/**
...
/// Create srv/Go2pointPrimitiveService message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * labust_msgs__srv__Go2pointPrimitiveService_Request__init().
...
/// Destroy srv/Go2pointPrimitiveService message.
/**
 * It calls
 * labust_msgs__srv__Go2pointPrimitiveService_Request__fini()
...
/// Initialize array of srv/Go2pointPrimitiveService messages.
/**
...
/// Finalize array of srv/Go2pointPrimitiveService messages.
/**
 * It calls
 * labust_msgs__srv__Go2pointPrimitiveService_Request__fini()
...
/// Create array of srv/Go2pointPrimitiveService messages.
/**
 * It allocates the memory for the array and calls
 * labust_msgs__srv__Go2pointPrimitiveService_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Go2pointPrimitiveService messages.
/**
 * It calls
 * labust_msgs__srv__Go2pointPrimitiveService_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * labust_msgs__srv__Go2pointPrimitiveService_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_labust_msgs
...
/**
 * It calls
 * labust_msgs__srv__Go2pointPrimitiveService_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_labust_msgs
...
/**
 * It allocates the memory for the array and calls
 * labust_msgs__srv__Go2pointPrimitiveService_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_labust_msgs
...
/**
 * It calls
 * labust_msgs__srv__Go2pointPrimitiveService_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // LABUST_MSGS__SRV__DETAIL__GO2POINT_PRIMITIVE_SERVICE__FUNCTIONS_H_
