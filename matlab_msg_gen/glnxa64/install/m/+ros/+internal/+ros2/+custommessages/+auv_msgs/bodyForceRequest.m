function [data, info] = bodyForceRequest
%BodyForceRequest gives an empty data for auv_msgs/BodyForceRequest
% Copyright 2019-2021 The MathWorks, Inc.
data = struct();
data.MessageType = 'auv_msgs/BodyForceRequest';
...
info.MessageType = 'auv_msgs/BodyForceRequest';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
