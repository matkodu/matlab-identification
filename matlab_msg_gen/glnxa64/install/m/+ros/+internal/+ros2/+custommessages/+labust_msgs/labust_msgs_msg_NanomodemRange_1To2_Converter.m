function ros2msg = labust_msgs_msg_NanomodemRange_1To2_Converter(message,ros2msg)
%labust_msgs_msg_NanomodemRange_1To2_Converter passes data of ROS message to ROS 2 message.
...
ros2msg.range_m = message.RangeM;
