...
{
  new (message_memory) labust_msgs::msg::BodyForceReq(_init);
}

void BodyForceReq_fini_function(void * message_memory)
{
  auto typed_message = static_cast<labust_msgs::msg::BodyForceReq *>(message_memory);
  typed_message->~BodyForceReq();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember BodyForceReq_message_member_array[5] = {
  {
    "header",  // name
    ...
    offsetof(labust_msgs::msg::BodyForceReq, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(labust_msgs::msg::BodyForceReq, goal),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(labust_msgs::msg::BodyForceReq, wrench),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(labust_msgs::msg::BodyForceReq, disable_axis),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<labust_msgs::msg::Windup6Axis>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(labust_msgs::msg::BodyForceReq, windup),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers BodyForceReq_message_members = {
  ...
  5,  // number of fields
  sizeof(labust_msgs::msg::BodyForceReq),
...
get_message_type_support_handle<labust_msgs::msg::BodyForceReq>()
{
  return &::labust_msgs::msg::rosidl_typesupport_introspection_cpp::BodyForceReq_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, labust_msgs, msg, BodyForceReq)() {
  return &::labust_msgs::msg::rosidl_typesupport_introspection_cpp::BodyForceReq_message_type_support_handle;
}
