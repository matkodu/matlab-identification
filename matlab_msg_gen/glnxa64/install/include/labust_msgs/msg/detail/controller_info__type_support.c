  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  labust_msgs__msg__ControllerInfo__init(message_memory);
}

void ControllerInfo__rosidl_typesupport_introspection_c__ControllerInfo_fini_function(void * message_memory)
{
  labust_msgs__msg__ControllerInfo__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember ControllerInfo__rosidl_typesupport_introspection_c__ControllerInfo_message_member_array[5] = {
  {
    "manual_topic",  // name
    ...
    offsetof(labust_msgs__msg__ControllerInfo, manual_topic),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(labust_msgs__msg__ControllerInfo, external_topic),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(labust_msgs__msg__ControllerInfo, state_topic),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(labust_msgs__msg__ControllerInfo, tracking_topic),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(labust_msgs__msg__ControllerInfo, state),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers ControllerInfo__rosidl_typesupport_introspection_c__ControllerInfo_message_members = {
  ...
  5,  // number of fields
  sizeof(labust_msgs__msg__ControllerInfo),
