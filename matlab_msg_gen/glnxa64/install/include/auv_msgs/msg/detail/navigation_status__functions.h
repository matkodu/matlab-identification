...
#ifndef AUV_MSGS__MSG__DETAIL__NAVIGATION_STATUS__FUNCTIONS_H_
#define AUV_MSGS__MSG__DETAIL__NAVIGATION_STATUS__FUNCTIONS_H_
 ...
 * calls
 * auv_msgs__msg__NavigationStatus__init().
...
/**
 * It calls
 * auv_msgs__msg__NavigationStatus__fini()
 ...
 * auv_msgs__msg__NavigationStatus__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * auv_msgs__msg__NavigationStatus__Sequence__fini()
 * on the array,
...
#endif  // AUV_MSGS__MSG__DETAIL__NAVIGATION_STATUS__FUNCTIONS_H_
